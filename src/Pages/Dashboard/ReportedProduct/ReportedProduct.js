...
const ReportedProduct = () => {
    ...
    const url = `https://social-media-server-seven.vercel.app/reporttoadmin`;
    ...
    const handleDeleteProduct = booking => {
        fetch(`https://social-media-server-seven.vercel.app/reporttoadmin/${booking._id}`, {
            method: 'DELETE', 
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
    ...
    //     fetch(`https://social-media-server-seven.vercel.app/users/${id}`, {
    //         method: 'DELETE', 
    //         headers: {
    //             authorization: `bearer ${localStorage.getItem('accessToken')}`
    //         }
