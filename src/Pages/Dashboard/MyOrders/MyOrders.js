...
const MyOrders = () => {
    ...
    const url = `https://social-media-server-seven.vercel.app/bookingsProduct?email=${user?.email}`;
    ...
    const handleDeleteProduct = booking => {
        fetch(`https://social-media-server-seven.vercel.app/bookingsProduct/${booking._id}`, {
            method: 'DELETE', 
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
