...
const AllPaidProducts = () => {
    ...
    const {data: bookings = [],isLoading, refetch} = useQuery({
        queryKey: ['bookings'],
        queryFn: async() =>{
            const res = await fetch('https://social-media-server-seven.vercel.app/allProducts');
    ...
    const handleDeleteProduct = booking => {
        fetch(`https://social-media-server-seven.vercel.app/allProducts/${booking.productId}`, {
            method: 'DELETE', 
            headers: {
