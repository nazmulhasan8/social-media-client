...
const ManageProducts = () => {
    ...
    const url = `https://social-media-server-seven.vercel.app/allProducts?email=${user?.email}`;
...
console.log(manageProducts);
    ...
    const handleDeleteProduct = booking => {
        fetch(`https://social-media-server-seven.vercel.app/allProducts/${booking._id}`, {
            method: 'DELETE', 
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
    ...
    const handleAdvertiseProduct = booking => {
        fetch(`https://social-media-server-seven.vercel.app/advertise`, {
            method: 'POST', 
            headers: {
